...
MAKE_EXAMPLE = 2;    // [0:Generate sample base part,1: Add fillets to base part,2: Add rounds to base part,3: Add fillets and rounds to base part,4: Add local fillets to base part,5: Add local rounds to base part,6: Add local fillets and local rounds to base part, 7: Show transparent local area selection box on base part]
...
module fillets_and_rounds(MAKE_EXAMPLE = 0, sample_R = 1, sample_OB = 1000, sample_axis = "xyz", sample_fn = 10) {
	//////////////////////////////////////////////////////////
